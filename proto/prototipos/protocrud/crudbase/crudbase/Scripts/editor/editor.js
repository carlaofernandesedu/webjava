    ...
    var methods = {
        ...
        init: function (options) {
            ...
            var menuItems = {
                ...
                //    "tooltip": "Transformar em parametro dinâmico",
                //    "commandname": null,
                //    "custom": function () {

                //        //document.execCommand('insertHTML', true, "<span class=editavel>" + document.getSelection() + "</span>");

                //        var r = getSelection().getRangeAt(0);
                //        r.insertNode(r.createContextualFragment("<span class=editavel>" + document.getSelection() + "</span>"));
            ...
            var $this = $(this).css({ 'opacity': '0', 'height': '0px', 'padding':'0px', 'margin':'0px' });

            /*
                $('textarea[name="Resposta"').show();
                $('textarea[name="Resposta"').css({ 'opacity':'0', 'height':'0px' })
            */

            methods.TextArea = $this;

            //$(containerDiv).find('.Editor-editor').attr('id', $this.attr('id'));
            //$.each($this.data(), function (index) {
            //    var prop = index;
            //    var value = $this.data(index);
            //    $this.removeData(prop);
            //    $(containerDiv).find('.Editor-editor').data(prop, value);
            //});

            $this.after(containerDiv);

            $(containerDiv).find('.Editor-editor').html($this.val());
            $(containerDiv).find('.Editor-editor').form = $this.form;
            ...
            if (settings['status_bar']) {
                editor.keyup(function (event) {
                    ...
                    $this.val($(containerDiv).find('.Editor-editor').html());
                    $this.trigger('change');
        ...
        setTextFormat: function () {
            ...
            methods.TextArea.val($(this).data("editor").html());
            $(this).data("editor").focus();
