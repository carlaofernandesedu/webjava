var CRUDFILTRO = (function () {
    ...
    return {
        ...
        Carregar: function () { BASE.Debug('funcao CRUDFILTRO Carregar nao definida'); return false; },
        Evento: {
            PreListar: function () { BASE.Debug('funcao CRUDFILTRO PreListar nao definida'); return false; },
            PosListar: function () { BASE.Debug('funcao CRUDFILTRO PosListar nao definida'); return false; },
            PosFitrarErro: function () { BASE.Debug('funcao CRUDFILTRO PosFitrarErro nao definida'); return false; }            
        },
        Filtrar: filtrar
    };
}());
